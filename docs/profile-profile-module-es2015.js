...
const routes = [
    ...
    { path: 'settings', loadChildren: () => __webpack_require__.e(/*! import() | settings-settings-module */ "settings-settings-module").then(__webpack_require__.bind(null, /*! ./settings/settings.module */ "./src/app/profile/settings/settings.module.ts")).then(m => m.SettingsModule) },
    { path: 'favs', loadChildren: () => __webpack_require__.e(/*! import() | favs-favs-module */ "favs-favs-module").then(__webpack_require__.bind(null, /*! ./favs/favs.module */ "./src/app/profile/favs/favs.module.ts")).then(m => m.FavsModule) },
    { path: 'messages', loadChildren: () => __webpack_require__.e(/*! import() | messages-messages-module */ "messages-messages-module").then(__webpack_require__.bind(null, /*! ./messages/messages.module */ "./src/app/profile/messages/messages.module.ts")).then(m => m.MessagesModule) }
];
